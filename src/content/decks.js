...
// `grow`: casillas de más respecto al tamaño elegido ({ cols, rows }).
...
export const DECKS = [
  ...
  { id: 'minigolf', color: '#A8743F', emblem: 'mill', scene: 'mini', grow: { cols: 8, rows: 0 },
  ...
  { id: 'ultimate', color: '#8E6BE0', emblem: 'prism', scene: 'prism', grow: { cols: 12, rows: 4 }, ultimate: true,
...
export const deckSize = (dk, sz) => ({ ...sz, cols: sz.cols + (dk.grow?.cols || 0), rows: sz.rows + (dk.grow?.rows || 0) });
