...
export const GRASS_C = ['#7fbf6a', '#a9dc8f', '#5fa552', '#d9f0c0'];
export const SAND_C  = ['#e8cf9a', '#d9b96f', '#f5e4b8', '#c9a558'];
export const CEMENT_C = ['#efece4', '#cfccc4', '#faf8f2'];
export const DIRT_C  = ['#a98a5c', '#8a6a3f', '#cbb289'];
export const WARP_C  = ['#b9a6ff', '#8f7ae0', '#e2d9ff', '#7c9bff'];
export const CONFETTI_C = ['#f26d6d', '#5b8def', '#f2b705', '#9b6dd6', '#2fbfa3', '#ffc95c'];
