...
export default {
  ...
  deckIntro: { title: 'Cartas nuevas', lead: 'Además de las cartas de siempre, esta baraja trae estas cartas especiales. Así funcionan:', start: 'salida', aria: 'Ejemplo animado de la carta en un tablero', button: 'Cartas nuevas' },
