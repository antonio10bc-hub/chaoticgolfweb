...
export default {
  ...
  cards: {
    ...
    paloIri: { name: 'Palo iridiscente', short: 'Iridiscente', desc: 'Tu pelota avanza sin parar hasta chocar con algo. Se para antes de un bloque o del borde; si choca con otra pelota, la golpeada sale disparada igual.' },
  ...
  hands: {
    rotate: 'Girar', rotateTitle: 'Girar la pieza (R)',
    hint: {
  ...
  tutorial: {
    ...
    card: {
      ...
      paloIri: 'Tu pelota avanza sin parar hasta chocar con algo: se para justo antes de un bloque o del borde (sin caerse). Si choca con otra pelota, la golpeada hereda todo el impulso.',
