...
export default {
  ...
  win: {
    ...
    rushHole: '¡Hoyo {n} completado!', rushScore: '{base} + {bonus} por rapidez', rushTotal: 'total: {n}', rushDone: '¡Contrarreloj terminado: {n} puntos!',
    nextHole: 'Hoyo {n}', modes: 'Modos', tourEnd: '¡Fin del torneo!', tourChampion: '¡Campeón del torneo!', tourWinner: 'Campeón: {names}', tourLater: 'Seguir otro día',
  ...
  pve: {
    ...
    namePh: 'Tu nombre',
    rivals: 'Rivales', rivalRandom: 'Al azar', rivalAny: 'cualquiera', rivalCycle: 'Toca para elegir rival',
  ...
  stats: {
    ...
    mode_story: 'Lo básico', mode_puzzle: 'Puzles', mode_daily: 'Reto diario', mode_rush: 'Contrarreloj', mode_tour: 'Torneo', mode_challenge: 'Desafíos', mode_pve: 'Partida rápida', mode_local: 'Multijugador local',
  ...
  modes: {
    title: 'Modos', sub: 'Retos para cada día, contrarreloj, torneos y desafíos',
    ...
    rush: { title: 'Contrarreloj', holes: '{n} hoyos generados', sub: 'Hoyos cada vez más difíciles. Menos turnos y más rapidez, más puntos.',
      best: 'Récord: {n} pts', continue: 'Seguir · hoyo {n}', pts: '{n} pts' },
    tour: { title: 'Torneo', holes: '{n} hoyos', sub: 'Una serie de partidas contra los mismos rivales. Gana quien más hoyos se lleve.',
      rivals: 'Rivales', start: 'Empezar torneo', continue: 'Seguir · hoyo {n}', titles: 'Torneos ganados: {n}' },
