...
export default {
  ...
  story: {
    ...
    puzzleGroups: { classic: 'Lo de siempre', pieces: 'Piezas nuevas: agua, madera y palos especiales', combo: 'Todo combinado' },
  ...
  challenges: {
    ...
    bunkers: { name: 'Mar de arena', desc: 'El campo empieza sembrado de búnkeres: casi no hay por dónde pasar.' },
    portals: { name: 'Atajos', desc: 'Tres parejas de portales de colores: cada uno te lleva al de su color.' },
    crowd: { name: 'Multitud', desc: 'Seis rivales en difícil: siete en la mesa. Sobrevive al caos.' },
    rapids: { name: 'Rápidos', desc: 'Tres ríos cruzan el campo desde el principio: la corriente te acerca… o te aleja.' },
    archipelago: { name: 'Archipiélago', desc: 'Un campo lleno de lagos: un mal golpe y vuelta a la salida.' },
    pinball: { name: 'Pinball', desc: 'Bloques y esquinas de madera por todas partes: cada golpe rebota y se desvía.' },
    launchpads: { name: 'Pista de despegue', desc: 'Cinco lanzaderas que giran cada turno: todo el mundo vuela.' },
    warren: { name: 'Madrigueras', desc: 'Seis túneles: nunca sabes por dónde vas a salir.' },
    prism: { name: 'Prisma', desc: 'Duelo en difícil con un mazo de palos iridiscentes: rebotan hasta chocar o caerse.' },
    sawmill: { name: 'Aserradero', desc: 'Ríos que desembocan en piezas de madera: la corriente te lleva a través de ellas.' },
    fullChaos: { name: 'Caos total', desc: 'De todo desde el principio: agua, madera, portales y búnkeres, con todas las cartas.' },
  },
