...
export default {
  ...
  cards: {
    ...
    launcher: { name: 'Lanzadera', desc: 'Coloca una lanzadera (elige su flecha): quien pasa por encima vuela 5 casillas hacia la flecha. Gira cada turno.' },
  ...
  story: {
    ...
    tips: {
      ...
      launcher: '¡Lanzadera! Vuela 5 casillas hacia la flecha.',
  ...
  tutorial: {
    ...
    card: {
      ...
      launcher: 'Colocas una lanzadera y eliges su flecha. Quien pasa por encima pierde el resto del movimiento y vuela 5 casillas hacia la flecha. Cada turno gira un cuarto de vuelta.',
  ...
  rules: {
    ...
    miniH: 'Minigolf', mini: 'Las piezas de madera no cuentan como casilla y nadie se queda encima. Bloque: la pelota (o el hoyo) rebota y vuelve por donde venía. Esquina: por su cara inclinada desvía 90°; por la espalda, rebota. Túnel: sale por uno de sus cuatro lados al azar. Lanzadera: quien pasa por encima vuela 5 casillas hacia su flecha y cae donde toque (hoyo, agua, otra pelota…); la flecha gira cada turno. El palo iridiscente (Ultimate) avanza hasta chocar con algo.',
