...
export default {
  ...
  win: {
    ...
    sum: { you: 'Tú', longest: 'Jugada más larga', longestV: '{n} casillas · {name}', hitter: 'Quien más te golpeó', hitterV: '{name} ×{n}', card: 'Tu carta más usada', cardV: '{card} ×{n}' },
  ...
  pve: {
    ...
    namePh: 'Tu nombre', nameAria: 'Tu nombre en la partida', nameAriaN: 'Nombre de la persona {n}', cycleColor: 'Cambiar de color',
  ...
  settings: {
    ...
    botFast: 'Acelerar los turnos de la máquina', botFastSub: 'Los bots juegan al doble de velocidad; tus jugadas, a tu ritmo',
