...
export default {
  ...
  editor: {
    ...
    deckH: 'Level deck (copies)', testH: 'Test', test: 'Test level',
    slotBadgeTitle: 'Slot it will be saved to / loaded from',
    tools: { ball: 'Ball', hole: 'Hole', bunker: 'Bunker', portal: 'Portal', par: 'PAR', erase: 'Erase' },
    info: 'Hole: ({hx},{hy}) · Ball: ({bx},{by})<br>Tiles: {tiles} · PAR cards: {pars} · Deck: {cards} cards',
    occupied: 'Square taken', occupiedErase: 'Square taken (use Erase first)', maxTiles: 'Max. {n} portals',
    ...
    importTitle: 'Import levels', importHint: 'Paste the levels JSON (replaces the current list) or load a .json file.',
    imported: '{n} level(s) imported', badJson: 'Invalid JSON',
  },
