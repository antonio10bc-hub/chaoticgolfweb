...
export default {
  ...
  win: {
    ...
    sum: { you: 'You', longest: 'Longest play', longestV: '{n} squares · {name}', hitter: 'Hit you the most', hitterV: '{name} ×{n}', card: 'Your most used card', cardV: '{card} ×{n}' },
    replay: 'Replay', next: 'Next level', levels: 'Levels', retry: 'Retry',
  ...
  pve: {
    ...
    namePh: 'Your name', nameAria: 'Your name in the game', nameAriaN: 'Person {n}’s name', cycleColor: 'Change colour',
  ...
  settings: {
    ...
    botFast: 'Speed up the bots’ turns', botFastSub: 'Bots play at double speed; your plays keep your pace',
