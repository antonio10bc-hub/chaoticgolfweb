...
export default {
  ...
  cards: {
    ...
    launcher: { name: 'Launcher', desc: 'Place a launcher (choose its arrow): whoever passes over it flies 5 squares towards the arrow. It turns every turn.' },
  ...
  story: {
    ...
    tips: {
      ...
      launcher: 'Launcher! It flies 5 squares towards the arrow.',
  ...
  tutorial: {
    ...
    card: {
      ...
      launcher: 'You place a launcher and choose its arrow. Whoever passes over it loses the rest of the move and flies 5 squares towards the arrow. It turns a quarter every turn.',
  ...
  rules: {
    ...
    miniH: 'Minigolf', mini: 'Wooden pieces don’t count as a square and nobody stays on top. Block: the ball (or the hole) bounces back the way it came. Corner: its slanted side turns it 90°; its back bounces it. Tunnel: it comes out of one of its four sides at random. Launcher: whoever passes over it flies 5 squares towards its arrow and lands wherever that is (hole, water, another ball…); the arrow turns every turn. The iridescent club (Ultimate) keeps going until it hits something.',
