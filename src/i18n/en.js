...
export default {
  ...
  cards: {
    ...
    paloIri: { name: 'Iridescent club', short: 'Iridescent', desc: 'Your ball keeps going until it hits something. It stops before a block or the edge; if it hits another ball, that ball shoots off the same way.' },
  ...
  hands: {
    rotate: 'Rotate', rotateTitle: 'Rotate the piece (R)',
    hint: {
  ...
  tutorial: {
    ...
    card: {
      ...
      paloIri: 'Your ball keeps going until it hits something: it stops right before a block or the edge (without falling off). If it hits another ball, that ball gets all the momentum.',
