...
export default {
  ...
  story: {
    ...
    puzzlesH: 'Puzzles: win in 1 turn', puzzleChip: 'Puzzle · win in 1 turn',
  ...
  weekly: {
    tinyChaos: { name: 'Tiny chaos', desc: '5×6 against 3 bots on hard.' },
    portalMaze: { name: 'Maze', desc: 'Portals and a hole that moves on its own.' },
    lakeDuel: { name: 'Lake duel', desc: 'A hard duel in the archipelago.' },
    bigHitters: { name: 'Big hitters', desc: 'Almost all 3-clubs on a big course.' },
    duel: { name: 'Duel', desc: 'You against a bot on hard.' },
    bunkerCrowd: { name: 'Packed beach', desc: 'Four rivals among bunkers.' },
    driftDuel: { name: 'Nervous hole', desc: 'A 5×5 duel with a restless hole.' },
    floodDrift: { name: 'Flood', desc: 'The rapids, with the hole moving on its own.' },
  ...
  decks: {
    classic: { name: 'Classic deck', desc: 'Clubs, finger, hole, bunker, portal and orange reactions.' },
    water: { name: 'Water deck', desc: 'Rivers that carry you and lakes that send you back to the start.' },
    minigolf: { name: 'Minigolf deck', desc: 'Blocks, corners, tunnels, launchers and 4 and 5 clubs.' },
    ultimate: { name: 'Ultimate Chaotic Golf', desc: 'Every card on a huge course, with 10 clubs and iridescent ones.' },
  ...
  challenges: {
    ...
    springboard: { name: 'Springboards', desc: 'Launchers by the start: jump on when they point at the hole.' },
    rapids: { name: 'Rapids', desc: 'Two rivers flow to the start… and carry the hole.' },
    archipelago: { name: 'Archipelago', desc: 'Lake islands: one bad shot and it’s back to the start.' },
    portals: { name: 'Shortcuts', desc: 'Three pairs of coloured portals.' },
    pinball: { name: 'Pinball', desc: 'Lanes, corners and blocks: play it off the cushions.' },
    warren: { name: 'Warren', desc: 'Tunnels everywhere: you never know where you’ll pop out.' },
    launchpads: { name: 'Runway', desc: 'Chains of launchers that open and close.' },
    longDrive: { name: 'Long course', desc: 'A long, narrow course for 4, 5 and 10 clubs.' },
    onlyOrange: { name: 'Only orange', desc: 'A duel of reactions: orange cards only.' },
    sawmill: { name: 'Sawmill', desc: 'Rivers flowing into wooden corners.' },
    locks: { name: 'Locks', desc: 'Rivers flowing into launchers.' },
    mirrors: { name: 'Mirrors', desc: 'A maze of corners: every shot turns.' },
    prism: { name: 'Prism', desc: 'Iridescent duel: bunkers act as stoppers.' },
    crowd: { name: 'Crowd', desc: 'Seven at the table, on hard.' },
    fullChaos: { name: 'Total chaos', desc: 'Water, wood, portals and bunkers all at once.' },
  },
