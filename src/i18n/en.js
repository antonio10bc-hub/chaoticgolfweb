...
export default {
  ...
  win: {
    ...
    rushHole: 'Hole {n} done!', rushScore: '{base} + {bonus} for speed', rushTotal: 'total: {n}', rushDone: 'Time attack over: {n} points!',
    nextHole: 'Hole {n}', modes: 'Modes', tourEnd: 'Tournament over!', tourChampion: 'Tournament champion!', tourWinner: 'Champion: {names}', tourLater: 'Continue another day',
  ...
  pve: {
    ...
    namePh: 'Your name',
    rivals: 'Rivals', rivalRandom: 'Random', rivalAny: 'anyone', rivalCycle: 'Tap to pick a rival',
  ...
  stats: {
    ...
    mode_story: 'The basics', mode_puzzle: 'Puzzles', mode_daily: 'Daily challenge', mode_rush: 'Time attack', mode_tour: 'Tournament', mode_challenge: 'Challenges', mode_pve: 'Quick game', mode_local: 'Local multiplayer',
  ...
  rules: {
    ...
    edgesH: 'Edges and collisions', edges: 'If a ball goes off the board it returns to its start. If it hits another ball it stops and passes on the movement it had left. The hole can move too and swallows any ball it lands on.',
  ...
  modes: {
    title: 'Modes', sub: 'Daily challenges, time attack, tournaments and challenges',
    ...
    rush: { title: 'Time attack', holes: '{n} generated holes', sub: 'Holes that get harder and harder. Fewer turns and more speed, more points.',
      best: 'Record: {n} pts', continue: 'Continue · hole {n}', pts: '{n} pts' },
    tour: { title: 'Tournament', holes: '{n} holes', sub: 'A series of games against the same rivals. Whoever wins the most holes wins.',
      rivals: 'Rivals', start: 'Start tournament', continue: 'Continue · hole {n}', titles: 'Tournaments won: {n}' },
  ...
  challenges: {
    ...
    bunkers: { name: 'Sea of sand', desc: 'The course starts full of bunkers.' },
    portals: { name: 'Shortcuts', desc: 'A big board with portals from the start.' },
    crowd: { name: 'Crowd', desc: 'Five rivals on hard. Survive the chaos.' },
  },
